...
namespace FCM.DAO
{
    class MatchDAO
    {
        ...
        public List<Match> GetListMatchByIDTeamWithOrder(int idTournament, int idTeam01)
        {
            List<Match> matches = new List<Match>();
        ...
        public List<Match> GetListMatchByID2Team(int idTournament, int idTeam01, int idTeam02)
        {
            List<Match> matches = new List<Match>();
